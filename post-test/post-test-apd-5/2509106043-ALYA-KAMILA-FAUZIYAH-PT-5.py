...
while True:
    while data_catatan == []:
        ...
        if pilihan_buat == "0":
            ...
            data_catatan.append(saldo_awal)
            data_catatan.append([])
            data_catatan[1].append(f"Saldo Awal: Rp {saldo_awal}")
        ...
        while True:
            ...
            if pilihan_menu == "1":
                ...
                print(f"Saldo saat ini: Rp {data_catatan[0]}")
                print()
                print("Riwayat Transaksi:")
                print("-" * 50)
                
                jumlah_riwayat = len(data_catatan[1])
                mulai = 0
                if jumlah_riwayat > 5:
                    mulai = jumlah_riwayat - 5
                
                for i in range(mulai, jumlah_riwayat):
                    print(data_catatan[1][i])
            ...
            # 2
                ...
                data_catatan[0] = data_catatan[0] + nominal
                data_catatan[1].append(f"+ Pemasukan: Rp {nominal} ({keterangan})")
                
                print()
                print("Pemasukan berhasil dicatat!")
                print(f"Saldo baru: Rp {data_catatan[0]}")
                print()
                input("Tekan Enter untuk kembali...")
            ...
            # 3
                ...
                if batal == False:
                    ...
                    data_catatan[0] = data_catatan[0] - nominal
                    data_catatan[1].append(f"- Pengeluaran: Rp {nominal} ({keterangan})")
            ...
            # 4
                ...
                print(f"Saldo saat ini: Rp {data_catatan[0]}")
                print(f"Total transaksi: {len(data_catatan[1])} transaksi")
                print()
